!(function () {
        ...
        (() => {
          ...
          a &&
            a.forEach((a) => {
              ...
              c.forEach((c) => {
                a.classList.contains("accordion-active")
                  ? ((c.checked = !0), e(r))
                  : ((c.checked = !1), t(r)),
                    ...
                    document.querySelectorAll(".accordion").forEach((e) => {
                      ...
                      "single" === s &&
                        ...
                        document.querySelectorAll(".collapse").forEach((e) => {
                          e.classList.value === o.target.classList.value &&
                          e.checked
                            ? (e.checked = !0)
                            : (e.checked = !1);
                        }),
                    ...
                    e.addEventListener("click", () => {
                      t.classList.contains(a)
                        ...
                        s &&
                          c &&
                          (t.classList.contains(a)
                            ? (t.classList.remove(c), t.classList.add(s))
                            : (t.classList.remove(s), t.classList.add(c)));
                    });
                  }
                });
            });
            ...
            r.querySelectorAll(".accordion").forEach((e) => {
              console.log(e),
                ...
                e.addEventListener("click", () => {
                  r.querySelectorAll(".accordion").forEach((e) => {
                    e.classList.contains("accordion-active")
                      ? (e.classList.remove(...c), e.classList.add(...s))
                      : (e.classList.remove(...s), e.classList.add(...c));
                  });
                });
            });
        })();
                ...
                document.querySelectorAll(".drawer-handler").forEach((l) => {
                  ...
                  l.addEventListener("click", () => {
                    if (i === o) {
                      const { classList: a } = s;
                      a.contains("active")
                        ? (a.remove(...e(c, r)), a.add(...t(c)))
                        : (a.remove(...t(c)), a.add(...e(c, r)));
                    } else
                      a.forEach((a) => {
                        const { classList: s } = a,
                          {
          ...
          e &&
            ...
            ((window.onclick = function (e) {
              e.target.matches(".dropdown") ||
                e.target.parentNode.matches(".dropdown") ||
                e.target.parentNode.parentNode.matches(".dropdown") ||
                e.target.parentNode.parentNode.parentNode.matches(
                  ".dropdown"
                ) ||
                t.forEach((e) => {
                  const { activeTop: t, deactiveTop: c } = e.dataset;
                  e.classList.remove(...a(t)), e.classList.add(...s(c));
                });
            }),
            e.forEach((e) => {
              ...
              "hover" === c
                ? (e.addEventListener("mouseenter", () => {
                  ...
                  e.addEventListener("mouseleave", () => {
                    ...
                    c.classList.remove(...a(r)), c.classList.add(...s(o));
                  }))
                : e.addEventListener("click", () => {
                    const { targetElement: c } = e.dataset,
                      r = document.getElementById(c),
                    ...
                    t.forEach((e) => {
                      ...
                      c !== t &&
                        (e.classList.remove(...a(o)), e.classList.add(...s(l)));
                    }),
                      r.classList.contains("visible")
                        ? (r.classList.remove(...a(o)),
                          r.classList.add(...s(l)))
                        : (r.classList.remove(...s(l)),
                          r.classList.add(...a(o)));
                  });
      ...
      228: function () {
        (() => {
          function e(e) {
            ...
            return { active: s.split(" "), deactive: c.split(" ") };
          }
                ...
                t.addEventListener("click", () => {
                  ...
                  document.querySelectorAll(".tab-button").forEach((t) => {
                    if (a === t.dataset.tabName) {
                      ...
                      if (a && s) {
                        const { active: a, deactive: s } = e(t);
                        t.classList.remove(...a), t.classList.add(...s);
                      }
                    }
                  }),
  ...
  function a(s) {
    ...
    var r = (t[s] = { exports: {} });
    return e[s](r, r.exports, a), r.exports;
  }
  a(215),
    a(919),
    a(733),
    ...
    document.querySelectorAll(".checkbox-checked").forEach((e) => {
      e.checked
        ? (e.style =
            "background-image: url('assets/img/icons/check/color-checked-squire.svg')")
        : (e.style = ""),
